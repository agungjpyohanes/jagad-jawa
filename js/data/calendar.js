// Data Kalender Jawa & Pranata Mangsa
...
export const BULAN_MASEHI = ["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"];
export const BULAN_JAWA = ["Sura","Sapar","Mulud","Bakda Mulud","Jumadilawal","Jumadilakhir","Rejeb","Ruwah","Pasa","Sawal","Dulkangidah","Besar"];
export const WINDU = ["Alip","Ehe","Jimawal","Je","Dal","Be","Wawu","Jimakir"];
...
export const DINO_GEDE_LIST = [
  ...
  ["Rabu","Pahing","Wuye"],["Sabtu","Kliwon","Wuye"],["Selasa","Pon","Manahil"],["Jumat","Legi","Manahil"],
...
export function getKeteranganKodeDetail(code) {
  if (!code) return [];
  const list = [];
  for (let ch of code) {
...
if (typeof module !== 'undefined' && module.exports) {
  ...
  module.exports.NEPTU_HARI = NEPTU_HARI;
  module.exports.PASARAN = PASARAN;
  module.exports.NEPTU_PASARAN = NEPTU_PASARAN;
  module.exports.BULAN_MASEHI = BULAN_MASEHI;
  module.exports.BULAN_JAWA = BULAN_JAWA;
  module.exports.WINDU = WINDU;
  module.exports.WUKU = WUKU;
  module.exports.DUNUNGE = DUNUNGE;
  module.exports.GRID = GRID;
  module.exports.KETERANGAN = KETERANGAN;
  module.exports.toJDN = toJDN;
  module.exports.jdnToIslamic = jdnToIslamic;
  module.exports.getDayInfo = getDayInfo;
  module.exports.getTanggalJawaLengkap = getTanggalJawaLengkap;
  module.exports.LIBUR_NASIONAL = LIBUR_NASIONAL;
  module.exports.getLiburNasional = getLiburNasional;
  module.exports.checkDinoGede = checkDinoGede;
  module.exports.KETERANGAN_MAP = KETERANGAN_MAP;
  module.exports.getKeteranganKodeDetail = getKeteranganKodeDetail;
  module.exports.DINO_GEDE_LIST = DINO_GEDE_LIST;
  module.exports.DINO_IJO_LIST = DINO_IJO_LIST;
  module.exports.normDinoWukuKey = normDinoWukuKey;
  module.exports.DINO_GEDE_SET = DINO_GEDE_SET;
  module.exports.DINO_IJO_SET = DINO_IJO_SET;
