...
const sasmithaDir = path.join(rootDir, 'data', '_tmp_sasmitha');

console.log('Parsing Sasmitha Gabungan...');
const sasmithaData = parseWorkbook(sasmithaDir);
fs.writeFileSync(path.join(rootDir, 'data', 'sasmitha_parsed.json'), JSON.stringify(sasmithaData, null, 2), 'utf8');
console.log('Sasmitha parsed successfully, sheets:', Object.keys(sasmithaData));
